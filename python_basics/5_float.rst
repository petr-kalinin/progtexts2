...
Или, например, атом водорода весит примерно 1.66e-27 грамм, т.е. 0.00000000000000000000000000166 грамм
...
-  **extended**, он же **long double** — хранит 19-20 цифр мантиссы, экспонента
...
Чисто 12.34 можно записать как 0.00000000012.34e11, и как 1234000000000e-11, и т.п.
Конечно, компьютер будет хранить число каким-то конкретным образом. Более того,
если, например, попробовать записать 0.00000000012.34e11 например в single,
...
(На самом деле конкретные числа, которые возможно записать — они немного другие, опять же из-за двоичной системы счисления,
