...
Значения, хранящиеся в массиве (говорят: элементы массива) нумеруются
последовательно, **начиная с нуля**. На картинке выше числа внутри
квадратиков — это значения, хранящиеся в массиве, а числа под
...
*одному и тому же* массиву длины ``n``. В итоге, если вы будете менять,
