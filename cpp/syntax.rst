...
.. note ::
    ...
    На самом деле не очень аккуратно говорить, что в неинициализированной числовой переменной есть какое-то значение.
    Если его попробовать прочитать, то компилятор имеет право сделать все что угодно.
    Даже сойти с ума: например, посчитать выражение ``x != x`` истинным или же результат ``x * 2`` чётным.

    Подробнее про причины — ниже, в разделе про неопределённое поведение.
    Единственное, что можно сделать с непроинициализированной числовой переменной — записать в неё значение,
    в том числе считав с клавиатуры или из файла.
    К массивам и строчкам это не относится: они всегда инициализируются пустыми, даже если вы этого не сделали.
