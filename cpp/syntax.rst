...
.. note ::
    ...
    Если же вы не проинициализировали C++-массив, то он гарантированно будет пустым.
...
это массив длины ``n``, заполненный нулями. Чтобы заполнить другими значениям, их надо указать после длины::
