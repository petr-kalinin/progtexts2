...
Если при выполнении вашей не вызвалось ни одной команды ``return <значение>``, то компилятор имеет право сойти с ума.
Например, следующая программа может вывести одну строчку, обе сразу, не вывести ничего вообще или упасть с ошибкойи
(это называется «неопределённое поведение», подробнее ниже)::
