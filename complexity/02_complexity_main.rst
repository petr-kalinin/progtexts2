...
у вас размер входных данных довольно большой (сотни, тысячи и т.д.) Если же у вас максимальное :math:`N` равно 10,
то сложность оценивать, конечно, можно и даже нужно, но проку от этого будет заметно меньше, чем
когда максимальное :math:`N` измеряется тысячами — просто потому, что при :math:`N=10` уже намного большее влияние
оказывают различия во временах выполнения отдельных операций и т.п.
