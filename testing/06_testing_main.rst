...
ложно, то она прерывает программу с ненулевым кодом возврата, как
...
(Это относительно сложный раздел, при первом чтении этого текста его можно пропустить, переходите сразу к разделу про отладку.)
...
Проверяйте типы и границы массивов
----------------------------------

Не поленитесь и отдельным действием (!), даже если программа вроде
работает и вы не можете найти контртест, подумайте, не может у вас
...
придумать контртест (см. предыдущий параграф). Но даже если не
...
перечитайте в конце тура ваше решение, особенно если есть время.
...
он будет тут полезен. Это относительно сложный раздел, при первом чтении этого текста его можно пропустить.
