...
:math:`r-l\leq \varepsilon`, и :math:`l\leq m_0\leq r`.
...
Тогда получится :math:`m=l` (в примере :math:`m=9\text{ div } 2=4=l`),
...
поиска). При вычислении :math:`(l+r)\text{ div }2` может произойти
