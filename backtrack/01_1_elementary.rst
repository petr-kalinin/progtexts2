...
\|\|noteЭто, пожалуй, единственный пример, когда в некоторых случаях
имеет смысл писать прямой перебор. Действительно, перебрать все
:math:`k`-значные двоичные числа можно легко:
``for i:=0 to (1 shl k) - 1 do`` — и :math:`i` пробежит все
...
\|\|noteКонечно, эту задачу, как и многие другие, которые мы тут будем
...
breakpoint с условием :math:`i=<{тому, что надо}>`, и жать F9.
...
.. task::
    ...
    :math:`N - {\it (сумма уже выбранных слагаемых)}`). При этом тогда
