...
Зацените порядок русских букв в KOI8-R — они так расположены, чтобы фонетически соответствовать латинским символам
(для совместимости с просмотрщиками, обрабатывающими только младшие семь бит).
...
-  UTF-16: в ней часть символов занимает 2 байта, а часть — четыре
   ...
   В остальном же я четырёхбайтовые символы я ни разу не встречал, поэтому в
...
.. note::
   ...
   страницы и показывается как странные квадратики.
